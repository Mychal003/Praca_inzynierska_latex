...
\end{lstlisting}
Powyższy listing przedstawia główne funkcje modułu \texttt{auth.js}:
...
Dzięki temu moduł umożliwia bezpieczne uwierzytelnianie użytkowników
oraz ochronę chronionych endpointów w aplikacji.
\newpage
